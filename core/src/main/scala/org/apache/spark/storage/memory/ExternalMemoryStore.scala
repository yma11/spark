...
private[spark] class ExternalMemoryStore(
  ...
  // ExternalStorageMemoryListener will connect this method with velox memory allocator.allocate()
  ...
  // ExtStorageMemoryListener will connect this method with velox memory allocator.free()
