        ...
        <ul class="unstyled">
          ...
          {if (hasBytesSpilled(stageData)) {
            ...
            <li>
              ...
              {s"${UIUtils.formatDuration(stageData.shuffleSpillWriteTime)}"}
             </li>
             <li>
               <strong>Spill Read Time</strong>
               {s"${UIUtils.formatDuration(stageData.shuffleSpillReadTime)}"}
             </li>
             <li>
               <strong>Spill Delete Time</strong>
               {s"${UIUtils.formatDuration(stageData.shuffleSpillDeleteTime)}"}
             </li>
          }}
