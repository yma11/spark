...
public class UnsafeExternalSorterSpillToPMemSuite {
    ...
    private UnsafeExternalSorter newSorter() {
    ...
    private void verifyIntIterator(UnsafeSorterIterator iter, int start, int end)
        ...
        for (int i = start; i < end; i++) {
            assert (iter.hasNext());
            iter.loadNext();
            // System.out.println(iter.getKeyPrefix() + " " + Platform.getInt(iter.getBaseObject(), iter.getBaseOffset()) + " " + i);
